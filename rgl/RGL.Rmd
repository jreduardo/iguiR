...
library(rmarkdown)
opts_chunk$set(comment = NA, cache = TRUE,
...
<center>
```{r toggle, webgl = TRUE, rgl.keepopen = TRUE, echo=FALSE}
...
with(subset(iris, Species == "virginica"), 
     spheres3d(Sepal.Length, Sepal.Width, Petal.Length, 
               col=as.numeric(Species),
     	       radius = 0.211))
aspect3d(1,1,1)
decorate3d(xlab = "Sepal.Length", ylab = "Sepal.Width", zlab = "Petal.Length", las = 2)
