...
##--------------------------------------------------------------------------------------------------
## Gráfico com os três eixos com a interface rgl e 3d
x <- c(0, 1, 0, 0)
y <- c(0, 0, 1, 0)
z <- c(0, 0, 0, 1)
...
# Gráfico de uma amostra aleatória e um elipsóide representando a concentração correspondente à
...
##--------------------------------------------------------------------------------------------------
## Região de confiança dos coeficientes de regressão
# Representa a região de confiança de 90% estimada e conjunta para os coeficientes de reg das variáveis
...
##--------------------------------------------------------------------------------------------------
## Permite a seleção de alguns pontos e redesenhá-los com uma cor diferente
if (interactive()) {
  x <- rnorm(1000)
  y <- rnorm(1000)
  z <- rnorm(1000)
...
ids <- plot3d( xyz )
if (interactive()) {
  # Clique próximo ao ponto a se selecionado e coloque uma esferra neleClick near a point to select it and put a sphere there.
...
demo(lsystem)
demo(subdivision)
demo(bivar) # requires MASS library
